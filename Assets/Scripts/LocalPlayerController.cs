...
#pragma warning restore 618
        ...
        /// <param name="prefab">Prefab/Model of the object to be instantiated.</param>
#pragma warning disable 618
        [Command]
#pragma warning restore 618
        public void CmdSpawnStar(Vector3 position, Quaternion rotation, GameObject prefab)
        {
            // Instantiate Star model at the hit pose.
            Debug.Log(prefab.tag + " is spawned.");
            var starObject = Instantiate(prefab, position, rotation);

            starObject.GetComponent<StarController>().SetParentToWorldOrigin();
            CloudAnchorsExampleController.Instance.lastSelectedObject = starObject.GetComponent<PlacementObject>();
...
#pragma warning restore 618
                ...
                /// <summary>
        /// A command run on the server that will despawn all Star prefabs in all clients.
        /// </summary>
        /// <param name="gameObject">The object to be destroyed</param>
#pragma warning disable 618
        [Command]
#pragma warning restore 618
        public void CmdDespawnAll()
        {
            ...
            {
#pragma warning disable 618
                NetworkServer.Destroy(tagObject);
#pragma warning restore 618
            }
        }
